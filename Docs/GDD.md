...
```mermaid
flowchart LR
  A[Cios wręcz] -->|wypada| B[Złom]
  B -->|amunicja| C[Strzał]
  C -->|trafienia| D[Moc]
  A -->|trafienia| D
  D -->|pełny pasek| E[Czar specjalny]
  E -->|rozrzuca wrogów| A
```
...
```mermaid
flowchart LR
  H[Trzepak<br/>hub] --> A1[Akt I Garaże<br/>Kapitan Sikawka]
  A1 --> A2[Akt II Pawilon<br/>Królowa Kolejki]
  A2 --> A3[Akt III Pośredniak<br/>Pani z Okienka]
  A3 --> A4[Akt IV Zalana Ulica<br/>Generał]
  A4 --> A5[Akt V Więzienie<br/>Naczelnik Kraty]
  A5 --> A6[Akt VI Blok nr 4<br/>Dozorca Klatki]
  A6 --> F[Finał<br/>Ojciec]
```
